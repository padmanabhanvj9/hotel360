...
def QueryReservationSearch():
    ...
    sql_value = json.loads(dbget("select pf_individual_profile.pf_firstname as firstname,pf_individual_profile.pf_lastname,\
            pf_individual_profile.pf_language,pf_individual_profile.pf_title,pf_individual_profile.pf_individual_country,pf_individual_profile.pf_mobileno,pf_individual_profile.pf_individual_vip,\
