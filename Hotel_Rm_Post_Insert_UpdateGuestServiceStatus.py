...
def hotel_rm_post_select_queryguestservicestatus(request):
     sql = json.loads(dbget("select guest_service_status.rm_service_status,rm_room_list.* from room_management.guest_service_status\
                           left join room_management.rm_room_list \
