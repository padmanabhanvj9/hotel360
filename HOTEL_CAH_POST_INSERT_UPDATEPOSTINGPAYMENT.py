...
def HOTEL_CAH_POST_INSERT_UPDATEPOSTINGPAYMENTCHECKOUT(request):
    ...
    #print("bala",balance[0]['res_guest_balance'],type(balance[0]['res_guest_balance']))
    ...
    sql_value = json.loads(dbget("select reservation.res_reservation.res_guest_status \
                                  from reservation.res_reservation where res_id="+res_id+" and \
                                  res_room="+res_room+" "))
    print("sql", sql_value, type(sql_value))
